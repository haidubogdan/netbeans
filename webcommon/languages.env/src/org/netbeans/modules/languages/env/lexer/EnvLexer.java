...
import org.netbeans.modules.languages.env.grammar.antlr4.EnvAntlrGrammarLexer;
import static org.netbeans.modules.languages.env.grammar.antlr4.EnvAntlrGrammarLexer.*;
 ...
 * @author bhaidu
 */
public class EnvLexer extends AbstractAntlrLexerBridge<EnvAntlrGrammarLexer, EnvTokenId> {
    public EnvLexer(LexerRestartInfo<EnvTokenId> info) {
        super(info, EnvAntlrGrammarLexer::new);
    }
    ...
    protected Token<EnvTokenId> mapToken(org.antlr.v4.runtime.Token antlrToken) {
        return switch (antlrToken.getType()) {
            ...
            case OPERATOR, ASSIGN_OPERATOR, CURLY_OPEN, CURLY_CLOSE -> token(EnvTokenId.OPERATOR);
    ...
    private static class State extends AbstractAntlrLexerBridge.LexerState<EnvAntlrGrammarLexer> {

        public State(EnvAntlrGrammarLexer lexer) {
            super(lexer);
        }

        @Override
        public void restore(EnvAntlrGrammarLexer lexer) {
            super.restore(lexer);
        }
    }
}
