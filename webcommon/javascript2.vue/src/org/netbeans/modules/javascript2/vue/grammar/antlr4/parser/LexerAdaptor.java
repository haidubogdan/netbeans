...
public abstract class LexerAdaptor extends Lexer {
    ...
    public void incrementTemplateTagBalance() {
        templateTagBalance++;
    }

    public void decreaseTemplateTagBalance() {
        templateTagBalance--;
    }

    public void setTemplateTagBalance(int balance) {
        templateTagBalance = balance;
    }

    public int getTemplateTagBalance() {
        return templateTagBalance;
    }
}
