...
import org.netbeans.modules.docker.execution.containers.DockerContainerPreferences;
...
public class DockerExecuteCommand {
    ...
    public static final String DOCKER_PREF_PATH = "docker_path";

    public static final String DOCKER_BASE_COMMAND = "/usr/bin/docker"; // NOI18N
    ...
    public static final String JS_DOCKER_PATH = "docker_exec/commands/javascript";

    public static String getDockerExecutablePath() {
        return NbPreferences.forModule(DockerExecuteCommand.class).get(DOCKER_PREF_PATH, DOCKER_BASE_COMMAND);
    }

    public static DockerExecConfiguration findJSDockerCommandConfiguration(Project project) {
    ...
    public static List<String> generateExecutableParams(Project project, AppType type) {
        ...
        DockerExecConfiguration config = switch (type) {
            case JAVASCRIPT ->
                findJSDockerCommandConfiguration(project);
            default ->
                null;
        };
