 ...
 * @author bhaidu
 */
public class DockerExecutable implements IExecutable {
...
//            return processBuilder;
    ...
    @Override
    public IExecutable additionalParameters(List<String> additionalParameters) {
    ...
    @Override
    public Integer runAndWait(ExecutionDescriptor executionDescriptor, String progressMessage) throws ExecutionException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public Integer runAndWait(ExecutionDescriptor executionDescriptor, ExecutionDescriptor.InputProcessorFactory2 outProcessorFactory, String progressMessage) throws ExecutionException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    @Override
    public Future<Integer> run(ExecutionDescriptor executionDescriptor) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
