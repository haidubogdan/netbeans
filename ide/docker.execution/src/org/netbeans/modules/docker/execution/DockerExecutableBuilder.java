...
public class DockerExecutableBuilder {
    ...
    public static DockerExecutable createExecutable(Project project, List<String> commandArguments) {
        DockerProjectPreferences dockerPreferences = new DockerProjectPreferences(project);
        
        return new DockerExecutable(dockerPreferences.getDockerContainerName(),
