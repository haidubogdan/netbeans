...
public class DockerProjectPreferences {
    ...
    public void setDockerConfigName(String profile) {
        getPreferences().put(DOCKER_CONFIG_NAME, profile);
    }
    ...
    public void setJSDockerConfig(String configName) {
        ...
        getJSDockerPreferences().put(DOCKER_CONFIG_NAME, configName);
    }
    ...
    public String getJSDockerConfigName() {
        ...
        return getJSDockerPreferences().get(DOCKER_CONFIG_NAME, null);
    }
