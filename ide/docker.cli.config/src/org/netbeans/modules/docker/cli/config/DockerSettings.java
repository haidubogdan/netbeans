...
public class DockerSettings {
    ...
    public static String getDockerExecutablePath() {
        ...
        return NbPreferences.forModule(DockerExecuteParams.class).get(DOCKER_EXEC_FILE_PATH, basePath);
    }
    
    public static void setDockerExecutablePath(String path) {
        NbPreferences.forModule(DockerExecuteParams.class).put(DOCKER_EXEC_FILE_PATH, path);
    }
}
