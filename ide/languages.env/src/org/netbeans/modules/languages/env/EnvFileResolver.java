...
public class EnvFileResolver extends MIMEResolver {
     ...
     * ex: compiled golden test files like *.lexer, *.error
     */
    ...
    @CheckForNull
    @Override
    public String findMIMEType(@NonNull final FileObject file) {
        if (isEnvFile(file)) {
            return MIME_TYPE;
        }
    ...
    public static boolean isEnvFile(FileObject file) {
