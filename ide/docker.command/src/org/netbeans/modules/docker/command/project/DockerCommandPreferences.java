...
public class DockerCommandPreferences {

    private static final String DOCKER_COMMAND_CONFIG_NAME = "docker.exec.command.configname"; // NOI18N
    ...
    public DockerCommandPreferences(Project project) {
        assert project != null;
        this.dockerPreferences = ProjectUtils.getPreferences(project, DockerCommandPreferences.class, true);
    }

    public void setDockerCommandConfigName(String profile) {
        getPreferences().put(DOCKER_COMMAND_CONFIG_NAME, profile);
    }

    public String getDockerCommandConfigName() {
        return getPreferences().get(DOCKER_COMMAND_CONFIG_NAME, DEFAULT_CONFIG_NAME);
    }
    ...
    public void setJSDockerConfig(String configName) {
        ...
        getJSDockerPreferences().put(DOCKER_COMMAND_CONFIG_NAME, configName);
    }
    ...
    public String getJSDockerConfigName() {
        ...
        return getJSDockerPreferences().get(DOCKER_COMMAND_CONFIG_NAME, null);
    }
