 ...
 * under the License.
 */
package org.netbeans.modules.docker.command.containers;

import java.util.prefs.Preferences;
import org.openide.util.NbPreferences;

public class DockerContainerPreferences {

    private static final String DOCKER_CONTAINERS = "DockerContainers"; // NOI18N
    public static final String CONTAINER_NAME = "container_name"; // NOI18N
