...
public class DockerExecutablePreference {
    ...
    public static String getDockerExecutablePath() {
        ...
        return NbPreferences.forModule(DockerExecuteCommand.class).get(DOCKER_PREF_PATH, basePath);
    }
    
    public static void setDockerExecutablePath(String path) {
        NbPreferences.forModule(DockerExecuteCommand.class).put(DOCKER_PREF_PATH, path);
    }
}
