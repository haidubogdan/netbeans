...
public interface ASTPHP5Symbols {
  ...
  public static final int T_DIV = 124;
  public static final int T_LOGICAL_OR = 86;
  public static final int T_DIR = 76;
  public static final int T_OPEN_PARENTHESE = 151;
  public static final int T_REFERENCE = 109;
  public static final int T_COMMA = 85;
  public static final int T_FINALLY = 43;
  public static final int T_ELSE = 144;
  public static final int T_IS_EQUAL = 110;
  public static final int T_LIST = 58;
  public static final int T_NAMESPACE = 74;
  public static final int T_NS_SEPARATOR = 77;
  public static final int T_OR = 107;
  public static final int T_IS_IDENTICAL = 112;
  public static final int T_INC = 129;
  public static final int T_ELSEIF = 143;
  public static final int T_NAME_FULLY_QUALIFIED = 172;
  public static final int T_TRY = 40;
  public static final int T_START_NOWDOC = 157;
  public static final int T_PRIVATE = 148;
  public static final int T_UNSET_CAST = 137;
  public static final int T_NAME_QUALIFIED = 171;
  public static final int T_INCLUDE_ONCE = 81;
  public static final int T_ENDIF = 142;
  public static final int T_SR_EQUAL = 102;
  public static final int EOF = 0;
  public static final int T_CALLABLE = 60;
  public static final int T_PUBLIC = 150;
  public static final int T_OBJECT_OPERATOR = 55;
  public static final int T_TILDA = 127;
  public static final int T_PAAMAYIM_NEKUDOTAYIM = 73;
  public static final int T_IS_SMALLER_OR_EQUAL = 114;
  public static final int T_ELLIPSIS = 163;
  public static final int T_XOR_EQUAL = 100;
  public static final int T_ENDFOREACH = 20;
  public static final int T_CONSTANT_ENCAPSED_STRING = 12;
  public static final int T_BACKQUATE = 156;
  public static final int T_AT = 138;
  public static final int T_AS = 25;
  public static final int T_CURLY_CLOSE = 72;
  public static final int T_ENDDECLARE = 22;
  public static final int T_PROTECTED_SET = 174;
  public static final int T_CATCH = 41;
  public static final int T_CASE = 29;
  public static final int T_VARIABLE = 8;
  public static final int T_INSTEADOF = 160;
  public static final int T_NEW = 141;
  public static final int T_MINUS_EQUAL = 93;
  public static final int T_PLUS = 121;
  public static final int T_SL_EQUAL = 101;
  public static final int T_ENDWHILE = 16;
  public static final int T_ENDFOR = 18;
  public static final int T_TRAIT = 159;
  public static final int T_CLONE = 24;
  public static final int T_BOOLEAN_OR = 105;
  public static final int T_UNSET = 47;
  public static final int T_INTERFACE = 52;
  public static final int T_SWITCH = 26;
  public static final int T_IS_GREATER_OR_EQUAL = 115;
  public static final int T_OPEN_RECT = 139;
  public static final int T_CURLY_OPEN_WITH_DOLAR = 70;
  public static final int T_FINAL = 147;
  public static final int T_REQUIRE = 83;
  public static final int T_PRIVATE_SET = 175;
  public static final int T_FILE = 66;
  public static final int T_DEC = 130;
  public static final int T_CLOSE_PARENTHESE = 152;
  public static final int T_CLASS_C = 61;
  public static final int T_EVAL = 82;
  public static final int T_MATCH = 28;
  public static final int T_POW = 161;
  public static final int T_RGREATER = 117;
  public static final int T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG = 168;
  public static final int T_IS_NOT_IDENTICAL = 113;
  public static final int T_NOT = 126;
  public static final int T_REQUIRE_ONCE = 84;
  public static final int T_POW_EQUAL = 162;
  ...
  public static final int T_SPACESHIP = 116;
  public static final int T_VAR = 46;
  public static final int T_START_HEREDOC = 67;
  public static final int T_ENDSWITCH = 27;
  public static final int T_OBJECT_CAST = 135;
  public static final int T_ECHO = 13;
  public static final int T_LINE = 65;
  public static final int T_FOR = 17;
  public static final int T_NAME_RELATIVE = 170;
  public static final int T_IMPLEMENTS = 54;
  public static final int T_ARRAY_CAST = 134;
  public static final int T_DOLLAR = 154;
  public static final int T_TIMES = 123;
  public static final int T_DOUBLE_CAST = 132;
  public static final int T_BOOL_CAST = 136;
  public static final int T_PRECENT = 125;
  public static final int T_LNUMBER = 4;
  public static final int T_CURLY_OPEN = 71;
  public static final int T_DEFINE = 79;
  public static final int T_QUESTION_MARK = 103;
  public static final int T_END_NOWDOC = 158;
  public static final int T_USE = 44;
  public static final int T_KOVA = 108;
  public static final int T_IF = 3;
  public static final int T_MUL_EQUAL = 94;
  public static final int T_ARRAY = 59;
  public static final int T_LGREATER = 118;
  public static final int T_COALESCE_EQUAL = 165;
  public static final int T_SEMICOLON = 104;
  public static final int T_NEKUDOTAIM = 153;
  public static final int T_VAR_COMMENT = 78;
  public static final int T_CONCAT_EQUAL = 96;
  public static final int T_PIPE_OPERATOR = 91;
  public static final int T_YIELD = 38;
  public static final int T_AND_EQUAL = 98;
  public static final int T_DNUMBER = 5;
  public static final int T_MINUS = 122;
  ...
  public static final int T_INT_CAST = 131;
